...
export class SaveVideoDetailsComponent {
  ...
  constructor(private activatedRoute: ActivatedRoute, private videoService: VideoService,
    ...
    this.videoService.getVideo(this.videoId).subscribe(data => {
      ...
      this.saveVideoDetailsForm.controls['title'].setValue(data.title);
      this.saveVideoDetailsForm.controls['description'].setValue(data.description);
      this.saveVideoDetailsForm.controls['videoStatus'].setValue(data.videoStatus);
      console.log("---------------");
